"""
Sirius BIST KATILIM - Top 5 Saf Momentum - Performans Takipli

Yoneticinin sistemiyle birebir paraleli:
...
SISTEM_KODU = "bist_katilim"


def main():
    print("=" * 70)
    print("SIRIUS BIST KATILIM - Performans Takipli")
    print("=" * 70)
    ...
    try:
        ...
        # Adim 2: Fiyat verisi
        print("\n[2/5] Fiyat verisi cekiliyor (5-10 dakika)...")
